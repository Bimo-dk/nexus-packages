---
'@bimo-dk/nexus-bus': minor
---

New package `@bimo-dk/nexus-bus` — typed publish/subscribe + request/response event bus for cross-component communication in a federated app. Federated remotes can talk to each other (and to the host) without direct imports by injecting a shared `NexusBus` service.
